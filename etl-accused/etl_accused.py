...
class AccusedETL:
    ...
    def ensure_run_state_table(self):
        ...
        try:
            ...
            logger.warning(
                "⚠️  Could not initialize etl_bookkeeping (continuing without checkpoint persistence): %s",
                e,
            )
    ...
    def get_run_checkpoint(self, module_name: str) -> Optional[datetime]:
        ...
        try:
            ...
            self.run_state_enabled = False
            logger.warning(
                "⚠️  Could not read etl_bookkeeping checkpoint (continuing without checkpoint read): %s",
                e,
            )
            return None
    ...
    def update_run_checkpoint(self, module_name: str, end_date_iso: str):
        ...
        try:
            ...
            self.run_state_enabled = False
            logger.warning(
                "⚠️  Could not persist etl_bookkeeping checkpoint (continuing): %s",
                e,
            )
